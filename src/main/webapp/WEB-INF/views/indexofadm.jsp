...
<nav class="navbar navbar-expand-lg navbar-light bg-light bg-dark ">
    <div class="container">
        <a href="viewadm3"><img class="logo" src="img/logo.png" alt=""></a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu col-ms-3">
                        ...
                        <ul class="dropdown-submenu">
                            ...
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>Thành phố Barcelona sôi động</a>
                            </li>
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>Thành phố Cordoba cổ kính</a></li>
                        </ul>
                        <li><a class="dropdown-item col-ms-3" href="#"><i class="bi bi-globe-asia-australia"></i>DU LỊCH BỒ ĐÀO
                            NHA</a></li>
                        <ul class="dropdown-submenu">
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>Thung lũng Douro</a></li>
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>Thành cổ Guimarães</a></li>
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>Vùng tự trị Azores</a></li>
                        </ul>
                        <li><a class="dropdown-item col-ms-3" href="#"><i class="bi bi-globe-asia-australia"></i>DU LỊCH ĐỨC</a>
                        </li>
                        <ul class="dropdown-submenu">
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>Thủ đô Berlin</a></li>
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>München (Thành phố Munich)</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu col-ms-3">
                        <li><a class="dropdown-item hover-hsla" href="#"><i class="bi bi-globe-asia-australia"></i>Du Lịch Thành
                            Phố Đà Nẵng</a></li>
                        <ul class="dropdown-submenu">
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>Bà Nà Hills</a></li>
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>Bán Đảo Sơn Trà</a></li>
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>Thác Hoà Phú Thành</a></li>
                        </ul>
                        <li><a class="dropdown-item col-ms-3" href="#"><i class="bi bi-globe-asia-australia"></i>Du Lịch Thành
                            Phố Đà Lạt</a></li>
                        <ul class="dropdown-submenu">
                            ...
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>Thung Lũng Vàng</a></li>
                        </ul>
                        <li><a class="dropdown-item col-ms-3" href="#"><i class="bi bi-globe-asia-australia"></i>Du Lịch Thành
                            Phố Hạ Long </a></li>
                        <ul class="dropdown-submenu">
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>Vịnh Hạ Long</a></li>
                            <li><a class="dropdown-item" href="#"><i class="bi bi-backpack3"></i>Đảo Tuần Châu</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#"><i class="bi bi-transparency"></i>Combo Phổ Biến Hiện Nay</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#"><i class="bi bi-megaphone-fill"></i>Về Chúng Tôi</a>
                        </li>
                        <li><a class="dropdown-item" href="#"><i class="bi bi-buildings-fill"></i>Thông Tin Công Ty</a></li>
                ...
                <li class="nav-item dropdown">
                    <a class="text-warning nav-link" href="/viewadm4">Quản Lý</a>
                </li>
...
<!-- Main Content Body -->
<h4 class="ms-4 text-info">Những Tour Du Lịch Phổ Biến Hà Nội.</h4>
                        ...
                        <div class="col-sm-4">
                            <div class="card text-center">
                                ...
                                <div class="card-body">
                                    ...
                                    <div>
                                        <button type="button" class="btn btn-dark">Chi Tiết</button>
                                    </div>
                                </div>
                                <div class="card-footer"><i class="bi bi-cash-coin"></i> <fmt:formatNumber value="${item.price}" type="currency" pattern="#,###,### VNĐ"/></div>
                            </div>
                        </div>
                    </c:forEach>
                </div>
                        ...
                        <div class="slider-content-left-top-container">
                            <div class="slider-content-left-top ">
                                ...
                                <p>-LÝ DO LỰA CHỌN DOLPHIN TOUR
                                    Dolphin Tour–Thành lập từ 2014 - Đơn vị có hệ thống bán trải rộng khắp Hà Nội và Sài Gòn.
                                </p>
                                <a href=""><img src="img/slide2.png" alt=""></a>
                                <p>-Dolphin Tour–Thành lập từ 2014-Đơn vị có hệ thống bán trải rộng khắp Hà Nội và Sài Gòn, đảm bảo
                                    giá thành sát với nhu cầu của khách hàng nhất.</p>
                                <a href=""><img src="img/slide3.jpg" alt=""></a>
                                <p>-Các bữa ăn chất lượng, mức ăn cho khách cao nhất từ 18 EUR- 24 EUR, kết hợp phong phú giữa thực
                                    đơn Á (Trung Quốc, Việt Nam, Thái, Hàn).</p>
                                <a href=""><img src="img/slide4.png" alt=""></a>
                                <p>-Dolphin Tou –Thành lập từ 2014-Đơn vị có hệ thống bán trải rộng khắp Hà Nội và Sài Gòn, đảm bảo
                                    giá thành sát với nhu cầu của khách hàng nhất.</p>
                                <a href=""><img src="img/left56.jpg" alt=""></a>
                                <p>-ĐÀI LOAN - là một lục địa trên một hòn đảo xanh, không chỉ được biết đến như con rồng của chấu Á
...
<div class="tab-content" id="myTabsContent">
    ...
    <div class="row">
        <div class="ccc col-md-3 ps-3">
            <p class="image-caption"><i class="bi bi-balloon-heart-fill"></i>Tất Tần Tật Mọi Điều Cần Biết Về Xin Visa Du Lịch
                Hàn Quốc.</p>
            <img src="img/tintuc1.jpg" class="img-fluid">
        </div>
        <div class="ccc col-md-3 ps-3">
            <p class="image-caption"><i class="bi bi-balloon-heart-fill"></i>Top 10 Địa Điểm Tuyệt Đẹp Dành Cho Tín Đồ Mê Du
                Lịch Mỹ.</p>
            <img src="img/tintuc2.jpg" class="img-fluid">
        </div>
        <div class="ccc col-md-3 ps-3">
            <p class="image-caption"><i class="bi bi-balloon-heart-fill"></i>Khám Phá Mùa Thu Hàn Quốc-Gợi Ý Địa Điểm Vui
                Chơi,Lịch Trình Hấp.</p>
            <img src="img/tintuc3.png" class="img-fluid">
        </div>
        <div class="ccc col-md-3 ps-3">
            <p class="image-caption"><i class="bi bi-balloon-heart-fill"></i>Thủ Tục Đi Du Lịch Mỹ Thăm Thân Nhân Và Những Lưu
                Ý Cần Biết.</p>
    ...
    <div class="row">
        <div class="ccc col-md-3 ps-3">
            <p class="image-caption"><i class="bi bi-balloon-heart-fill"></i>Bí Quyết Du Lịch Hàn Quốc Tháng 11 - Lãng Mạn Mùa
                Lá Đỏ.</p>
            <img src="img/tintuc5.png" class="img-fluid">
        </div>
        <div class="ccc col-md-3 ps-3">
            <p class="image-caption"><i class="bi bi-balloon-heart-fill"></i>Chia Sẻ Kinh Nghiệm Du Lịch Hàn Quốc Mùa Lá Đỏ -
                Dolphin Tour.</p>
            <img src="img/tintuc6.png" class="img-fluid">
        </div>
        <div class="ccc col-md-3 ps-3">
            <p class="image-caption"><i class="bi bi-balloon-heart-fill"></i>HIỂU ĐÚNG, LÀM ĐÚNG CHỨNG MINH TÀI CHÍNH ĐI DU
                LỊCH MỸ.</p>
            <img src="img/tintuc7.jpg" class="img-fluid">
        </div>
        <div class="ccc col-md-3 ps-3">
            <p class="image-caption"><i class="bi bi-balloon-heart-fill"></i>Xin Visa Mỹ Cho Cả Gia Đình - Hướng Dẫn, Kinh
                Nghiệm Và.</p>
